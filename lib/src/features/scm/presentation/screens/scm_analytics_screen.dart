              ...
              child: ConstrainedBox(
                      ...
                      SizedBox(
                        ...
                        child: TabBar(
                          ...
                          unselectedLabelStyle: Theme.of(
                            context,
                          ).textTheme.bodyMedium?.copyWith(color: AppColors.unselectedTabTextColor),
                ...
                GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final card = DummyAnalyticsData.analyticsInfoCards[index];
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(
            'Electricity',
            style: Theme.of(context).textTheme.displayMedium?.copyWith(fontSize: 16, color: AppColors.lightGrey),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.totalPowerSliderColor, width: 20),
            ),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Total Power", style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.backButtonColor)),
                const SizedBox(height: 4),
                Text("5.53 kw", style: Theme.of(context).textTheme.displayMedium?.copyWith(color: AppColors.backButtonColor, fontSize: 16)),
              ],
            ),
          ),
          const SizedBox(height: 8),
          Container(
            ...
            child: TabBar(
              ...
              labelColor: AppColors.secondary,
              unselectedLabelColor: AppColors.unselectedTabTextColor,
              labelStyle: Theme.of(context).textTheme.displayMedium?.copyWith(color: AppColors.secondary, fontSize: 16),
              unselectedLabelStyle: Theme.of(context).textTheme.bodyLarge?.copyWith(color: AppColors.unselectedTabTextColor),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(sourceLoadData.getTitle, style: Theme
                          .of(context)
                          .textTheme
                          .labelSmall
                          ?.copyWith(
                          fontSize: 14, color: AppColors.backButtonColor)),
                      const SizedBox(width: 8),
                      Text("(${sourceLoadData.isActive ? "Active" : "Inactive"})", style: Theme
                          .of(context)
                          .textTheme
                          .labelSmall
                          ?.copyWith(
                          fontSize: 10, color: sourceLoadData.isActive ? AppColors.primary : AppColors.notificationIndicatorColor),)
                    ],
                  ),
                  const SizedBox(height: 4),
                  Text.rich(
                      ...
                      children: [
                        TextSpan(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .bodySmall
                              ?.copyWith(color: AppColors.backButtonColor),
                        ),
                      ],
                    ),
                  ),
